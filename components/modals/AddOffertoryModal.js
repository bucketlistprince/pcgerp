...
const AddOffertoryModal = ({ isOpen, onClose, onSubmit, date, setDate, offertoryAmount, setOffertoryAmount, comment, setComment }) => {
    ...
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-lg relative">
        ...
        <form onSubmit={onSubmit} className="mt-4">
          ...
          {/* Offertory amount input */}
          <div className="mb-4">
            <label className="block text-sm font-semibold mb-2">Offertory Amount (GHC)</label>
            <input
              type="number"
...
export default AddOffertoryModal;
